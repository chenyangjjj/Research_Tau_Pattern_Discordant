## This code is for the association analysis of CSF Aβ42/Aβ40, Aβ PET and CSF p-Tau/Aβ40 in early amyloidosis stage  
## main part
...
Data_ADNI_CSF_PET_Abeta_Tau_CU_MCI_v1 = subset(Data_ADNI_CSF_PET_Abeta_Tau_v1, 
                                               !((Diag_AV1451_v1 == "AD")))
...
Data_ADNI_CSF_PET_Abeta_Tau_CU_MCI_RM_Ref_T_P_v1_Stage23_Ref$Stage_CSF_PET_Abeta=
  factor(Data_ADNI_CSF_PET_Abeta_Tau_CU_MCI_RM_Ref_T_P_v1_Stage23_Ref$Stage_CSF_PET_Abeta,
         levels = c("CSF-/PET-","CSF+/PET-","CSF-/PET+"))
...
Col_Stage23_Ref = c("#4DAF4A", "#377EB8","coral1")
...
summary(GLM_ENTORHINAL_FTP_Vs_CSF_Abeta_Stage23_Ref)
...
Plot_ENTORHINAL_FTP_Vs_CSF_Abeta_Stage23_Ref = 
  ...
  geom_point(aes(color= Stage_CSF_PET_Abeta,shape = Diag_AV1451_v1),size = 2,alpha = 0.7) +
  scale_colour_manual(values = Col_Stage23_Ref)+
  scale_shape_manual(values = c(19,1)) +
  scale_x_continuous(breaks = seq(0.025,0.15,0.025),limits = c(0.025,0.15)) +
  scale_y_continuous(breaks = seq(0.8,2,0.2),limits = c(0.8,2)) +
  annotate("text", x = 0.0875, y = Inf,
           # label = expression(bold(italic(beta)*' = -0.25, '*italic(p)*' = 0.003')),
           label = expression(bold(italic(beta)*' = -0.22, '*italic(p)*' = 0.004')),
           size = 3.5, color="black",vjust = 2) +
...
Plot_ENTORHINAL_FTP_Vs_PET_Abeta_Stage23_Ref = 
  ...
  scale_colour_manual(values = Col_Stage23_Ref)+
  scale_shape_manual(values = c(19,1)) +
  scale_x_continuous(breaks = seq(-40,60,20),limits = c(-40,60)) +
  scale_y_continuous(breaks = seq(0.8,2,0.2),limits = c(0.8,2)) +
  annotate("text", x =  10, y = Inf,
           label = expression(italic(beta)*' = 0.12, '*italic(p)*' = 0.12'),
           size = 3.5, color="black",vjust = 2) +
...
Plot_ENTORHINAL_FTP_Vs_CSF_PTAU_Stage23_Ref = 
  ...
  scale_colour_manual(values = Col_Stage23_Ref)+
  scale_shape_manual(values = c(19,1)) +
  scale_x_continuous(breaks = seq(0.0005,0.0025,0.0005),limits = c(0.0005,0.0025)) +
  scale_y_continuous(breaks = seq(0.8,2,0.2),limits = c(0.8,2)) +
  annotate("text", x = 0.0015, y = Inf,
           label = expression(bold(italic(beta)*' = 0.47, '*italic(p)*' < 0.001')),
           size = 3.5, color="black",vjust = 2) +
...
Plot_BRAAK34_FTP_Vs_CSF_Abeta_Stage23_Ref = 
  ggplot(Data_ADNI_CSF_PET_Abeta_Tau_CU_MCI_RM_Ref_T_P_v1_Stage23_Ref,
         aes(x = CSF_ABETA42.ABETA40_Closest_AV1451_v1, 
  ...
  scale_y_continuous(breaks = seq(0.8,2,0.2),limits = c(0.8,2)) +
  annotate("text", x = 0.0875, y = Inf,
           label = expression(italic(beta)*' = -0.12, '*italic(p)*' = 0.15'),
           size = 3.5, color="black",vjust = 2 ) +
  xlab(expression('CSF A'*beta[42]*'/A'*beta[40])) +
...
Plot_BRAAK34_FTP_Vs_PET_Abeta_Stage23_Ref_Non_Y_Label = 
  ggplot(Data_ADNI_CSF_PET_Abeta_Tau_CU_MCI_RM_Ref_T_P_v1_Stage23_Ref,
         aes(x = PET_ABETA_CL_Closest_AV1451_v1, 
             y = BRAAK34_SUVR_FTP_Inf_CER_GM_Non_PVC_v1)) +
  geom_smooth(method="lm",  size = 1,linetype ="solid",
  ...
  scale_y_continuous(breaks = seq(0.8,2,0.2),limits = c(0.8,2)) +
  annotate("text", x =  10, y = Inf,
           label = expression(bold(italic(beta)*' = 0.22, '*italic(p)*' = 0.01')),
           size = 3.5, color="black",vjust = 2) +
  xlab(expression('A'*beta*' PET (Centiloid)')) +
  ylab(" ") +
  # guides(colour = guide_legend(nrow =2)) +
...
Plot_BRAAK34_FTP_Vs_PTAU_Stage23_Ref_Non_Y_Label = 
  ggplot(Data_ADNI_CSF_PET_Abeta_Tau_CU_MCI_RM_Ref_T_P_v1_Stage23_Ref,
         aes(x = CSF_PTAU.ABETA40_Closest_AV1451_v1, 
             y = BRAAK34_SUVR_FTP_Inf_CER_GM_Non_PVC_v1)) +
  geom_smooth(method="lm",  size = 1,linetype ="solid",
  ...
  scale_y_continuous(breaks = seq(0.8,2,0.2),limits = c(0.8,2)) +
  annotate("text", x =  0.0015, y = Inf,
           label = expression(bold(italic(beta)*' = 0.46, '*italic(p)*' < 0.001')),
           size = 3.5,color="black",vjust = 2) +
  xlab(expression('CSF p-Tau'*'/A'*beta[40])) +
  ylab(" ") +
  # guides(colour = guide_legend(nrow =2)) +
...
Plot_BRAAK34_FTP_Vs_CSF_PET_Abeta_Stage23_Ref = 
  ggarrange(
    Plot_BRAAK34_FTP_Vs_CSF_Abeta_Stage23_Ref,
    Plot_BRAAK34_FTP_Vs_PET_Abeta_Stage23_Ref_Non_Y_Label,
    Plot_BRAAK34_FTP_Vs_PTAU_Stage23_Ref_Non_Y_Label,
...
r_p_value = paste(paste("R = ",as.character(signif(r_value,2)),sep = ""),
                  paste("p = ",as.character(signif(p_value,2)),sep = ""),sep = ", ")
r_p_value
Plot_BRAAK56_FTP_Vs_CSF_Abeta_Stage23_Ref = 
  ggplot(Data_ADNI_CSF_PET_Abeta_Tau_CU_MCI_RM_Ref_T_P_v1_Stage23_Ref,
         aes(x = CSF_ABETA42.ABETA40_Closest_AV1451_v1, 
  ...
  annotate("text", x = 0.0875, y = Inf,
           label =  expression(italic(beta)*' = -0.01, '*italic(p)*' = 0.88'),
           size = 3.5,color="black",vjust = 2) +
  xlab(expression('CSF A'*beta[42]*'/A'*beta[40])) +
...
r_p_value = paste(paste("R = ",as.character(signif(r_value,2)),sep = ""),
                  paste("p = ",as.character(signif(p_value,2)),sep = ""),sep = ", ")
r_p_value
Plot_BRAAK56_FTP_Vs_PET_Abeta_Stage23_Ref_Non_Y_Label = 
  ggplot(Data_ADNI_CSF_PET_Abeta_Tau_CU_MCI_RM_Ref_T_P_v1_Stage23_Ref,
         aes(x = PET_ABETA_CL_Closest_AV1451_v1, 
             y = BRAAK56_SUVR_FTP_Inf_CER_GM_Non_PVC_v1)) +
  geom_smooth(method="lm",  size = 1,linetype ="solid",
  ...
  scale_y_continuous(breaks = seq(0.8,1.4,0.2),limits = c(0.8,1.4)) +
  annotate("text", x =  10, y = Inf,
           label = expression(bold(italic(beta)*' = 0.35, '*italic(p)*' < 0.001')),
           size = 3.5,color="black",vjust = 2) +
  xlab(expression('A'*beta*' PET (Centiloid)')) +
  ylab(" ") +
  # guides(colour = guide_legend(nrow =2)) +
...
r_p_value = paste(paste("R = ",as.character(signif(r_value,2)),sep = ""),
                  paste("p = ",as.character(signif(p_value,2)),sep = ""),sep = ", ")
r_p_value
Plot_BRAAK56_FTP_Vs_PTAU_Stage23_Ref_Non_Y_Label = 
  ggplot(Data_ADNI_CSF_PET_Abeta_Tau_CU_MCI_RM_Ref_T_P_v1_Stage23_Ref,
         aes(x = CSF_PTAU.ABETA40_Closest_AV1451_v1, 
             y = BRAAK56_SUVR_FTP_Inf_CER_GM_Non_PVC_v1)) +
  geom_smooth(method="lm",  size = 1,linetype ="solid",
  ...
  scale_y_continuous(breaks = seq(0.8,1.4,0.2),limits = c(0.8,1.4)) +
  annotate("text", x =  0.0015, y = Inf,
           label = expression(bold(italic(beta)*' = 0.18, '*italic(p)*' = 0.015')),
           size = 3.5,color="black",vjust = 2) +
  xlab(expression('CSF p-Tau'*'/A'*beta[40])) +
  ylab(" ") +
  # guides(colour = guide_legend(nrow =2)) +
...
Plot_BRAAK56_FTP_Vs_CSF_PET_Abeta_Stage23_Ref = 
  ggarrange(
    Plot_BRAAK56_FTP_Vs_CSF_Abeta_Stage23_Ref,
    Plot_BRAAK56_FTP_Vs_PET_Abeta_Stage23_Ref_Non_Y_Label,
    Plot_BRAAK56_FTP_Vs_PTAU_Stage23_Ref_Non_Y_Label,
...
ggsave("D:/Project/guo_20210206/CSF_PET_tau/Output/main_results/with_otuliers/1_with_outliers/Plot_Association_123_new.tiff",
       Plot_Association_BL_FTP_SUVR_Stages_CSF_PET_Abeta,
